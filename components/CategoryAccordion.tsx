            ...
            return (
              ...
              >
                <button
                  ...
                  className="w-full px-6 py-6 text-left lg:px-8 lg:py-7"
                >
                      ...
                      {category.items.map((item, i) => {
                        return (
                          <div
                            ...
                            className="cursor-pointer overflow-hidden rounded-[1.5rem] border border-[#D4AF37]/30 bg-[#C6AB73] text-left shadow-sm transition hover:-translate-y-1 hover:shadow-lg hover:shadow-[#2E1065]/10"
                          >
